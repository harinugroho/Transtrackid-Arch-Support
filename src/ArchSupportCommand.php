...
class ArchSupportCommand extends Command
{
    ...
    public function getStubPaths()
    {
        ...
        $path['storeRequest'] = __DIR__ . '/stubs/request-store.stub';
        ...
        $path['factory'] = __DIR__ . '/stubs/factory.stub';
    ...
    public function getSourceFilePaths()
    {
        ...
        $paths['storeRequest'] = base_path("app/Http/Requests/$model/Store{$model}Request.php");
        ...
        $paths['factory'] = base_path("database/factories/{$model}Factory.php");
